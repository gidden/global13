%% Finally, realism is introduced through integer
%% variables. For a number of facilities, especially reactors, it may not be
%% realistic for a given fuel order to be split amongst a variety of suppliers. The
%% realm of integer programming techniques allow us to introduced binary variables
%% to enforce this reality constraint.
